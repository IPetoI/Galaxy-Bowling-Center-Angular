...
export class ProfilComponent implements OnInit {
	...
	emailSzerkesztes() {
		let szerkesztoMezo = prompt("E-mail szerkesztése:\npélda: galaxybowlingcenter@gmail.com", this.jelenlegiEmailCim);
	...
	beszurHTMLKod() {
		...
		for (const adat of this.adatok) {
			...
			trElem.innerHTML = `
        <td style="background-color: black; text-align: center">${adat.szemelySzam}</td>
        <td style="background-color: black; text-align: center">${adat.hanyadika}</td>
        <td style="background-color: black; text-align: center">${adat.ora}</td>
        <td style="background-color: black; text-align: center">${adat.ar}</td>
        <td style="text-align: center"><button style="background-color: purple; background-image: url(../../../assets/kepek/kuka.png);
